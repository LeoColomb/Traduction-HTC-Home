...
5. Go to the `Extras\Locale` folder. You will see `en-US.ext.xml` file. Replace `en-US` to your culture name. Then you should edit it with Notepad:
	...
	* 1) You need new Cid - Component ID. Cid used by HTC Home Updater to get updates for installed components. To generate new Cid go to [GuidGen WebTool](http://guidgen.com). When you got new Cid, paste it between `<Cid></Cid>` tags in your xml file.
